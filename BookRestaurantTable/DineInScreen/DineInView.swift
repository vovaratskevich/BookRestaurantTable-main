        ...
        ZStack{
            VStack(alignment:.leading){
                ...
                HStack{
                    ...
                    .background( viewModel.selectedTime == "" ? Color(red: 0.96, green: 0.96, blue: 0.96) : Color(red: 0.24, green: 0.49, blue: 1))
                    .cornerRadius(24)
                    .padding()
                ...
                LazyHStack{
                    ForEach(arrTime,id: \.self)
                    {
                        ...
                        Button(action:{
                            ...
                            Text(time)
                                .padding()
                                .background( selectedTime == time ? Color.blue :  Color(red: 0.96, green: 0.96, blue: 0.96))
                                .frame(height: 48)
                                .cornerRadius(24)
